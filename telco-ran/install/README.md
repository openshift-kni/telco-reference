...
`telco-ran/install/extra-manifests-builder/`. At day-N, the Hub
...
change, that COPY source must point at `telco-ran/install/clusterinstance/extra-manifests/` while
