...
1. Assuming your cluster was deployed using [this ClusterInstance CR](../../install/clusterinstance/example-sno.yaml), add your new worker node to `spec.nodes` list, for example:
