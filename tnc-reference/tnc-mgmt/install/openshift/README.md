...
3. Also copy the `openshift` directory and all its files to the `ocp` directory. Edit the `catalogSource-disconnected.yaml` and `idms.yaml` files to reflect the correct URL for the private registry.
